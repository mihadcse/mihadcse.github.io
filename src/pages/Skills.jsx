    ...
    <div className='pt-16 px-6'>
      ...
      <div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6 mb-5 justify-items-center">
          ...
          <div className="badge text-center">
            <img src="https://img.icons8.com/?size=100&id=7I3BjCqe9rjG&format=png&color=000000" alt="Flutter logo" className="w-16 h-16" /><span>Flutter</span>
          </div>
          <div className="badge text-center">
            <img src="https://img.icons8.com/?size=100&id=90519&format=png&color=000000" alt="Spring Boot logo" className="w-16 h-16" />
